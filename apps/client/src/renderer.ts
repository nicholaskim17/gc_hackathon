...
export class Renderer {
  ...
  makeBox(){
    ...
    const label=this.label('POWER UP','#c4efff',44);label.position.y=.34;label.scale.set(1.18,.29,1);group.add(label);this.powerLabels.push(label);
